...
class CreateTableScvTHistoricoVisitantes extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('scv_t_historico_visitantes', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('scv_t_historico_visitantes');
    }
}
