<table id="data-table" class="table table-hover" style="width:100%">
    <thead>
        ...
        <th style="text-align: center" width="75%">GERENCIA</th>
    </thead>
</table>
...
@section('js')
    <script>
        ...
        let table = $('#data-table').DataTable({
            ...
            columns: [
                {
                    data: "id_gergral",render: function(data, type, row) {
...

                {
                    ...
                    render: function(data, type, row) {
                        ...
                        <a href="#winEditEstatus" data-registro="${URL_BASE}/gerencia/${row.id_gergral}"
