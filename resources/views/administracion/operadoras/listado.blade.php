<table id="data-table" class="table table-hover" style="width:100%">
    <thead>
		<th style="text-align: center" width="2%">EDITAR </th>
        <th style="text-align: center" width="2%">ELIMINAR </th>
        <th style="text-align: center" width="10%">OPERADORAS</th>
...
let table= $('#data-table').DataTable({
    ...
    ajax: URL_BASE+'/api/operadoras',
    columns:[
        {data:"id_operadora",render:function(data, type, row){
            return `<a href="#winEdit" data-registro='${URL_BASE}/operadoras/${data}/edit'"
        ...
        {data:"id_status",render:function(data, type, row){
            ...
            <a href="#winEditEstatus" data-registro="${URL_BASE}/operadoras/${row.id_operadora}"
