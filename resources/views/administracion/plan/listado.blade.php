<table id="data-table" class="table table-hover" style="width:100%">
    <thead>
        ...
        <th style="text-align: center" width="20%">MONTO CREDITO</th>
    </thead>
</table>
...
let table= $('#data-table').DataTable({
    ...
    ajax: URL_BASE+'/api/plan',
    columns:[
        {data:"id_plan",render:function(data, type, row){
            return `<a href="#winEdit" data-registro='${URL_BASE}/plan/${data}/edit'"
        ...
        {data:"id_status",render:function(data, type, row){
            ...
            <a href="#winEditEstatus" data-registro="${URL_BASE}/plan/${row.id_plan}"
