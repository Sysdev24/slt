<table id="data-table" class="table table-hover" style="width:100%">
    <thead>
        ...
        <th style="text-align: center" width="50%">ESTADO</th>
    </thead>
</table>
...
@section('js')
    ...
    ajax: URL_BASE+'/api/estados',
    columns:[
        {data:"id_estado",render:function(data, type, row){
            return `<a href="#winEdit" data-registro='${URL_BASE}/estados/${data}/edit'"
        ...
        {data:"id_status",render:function(data, type, row){
            ...
            <a href="#winEditEstatus" data-registro="${URL_BASE}/estados/${row.id_estado}"
