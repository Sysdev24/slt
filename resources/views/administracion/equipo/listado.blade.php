...
<script>
    ...
    let table= $('#data-table').DataTable({
        ...
        ajax: URL_BASE+'/api/equipo',
        columns:[
            {data:"id_sede_equipo",render:function(data, type, row){
                return `<a href="#winEdit" data-registro='${URL_BASE}/equipo/${data}/edit'"
            ...
            {data:"id_status",render:function(data, type, row){
                ...
                <a href="#winEditEstatus" data-registro="${URL_BASE}/equipo/${row.id_sede_equipo}"
