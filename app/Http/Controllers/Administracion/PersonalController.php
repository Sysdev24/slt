...
class PersonalController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $gergral = Gerencia::pluck('descripcion', 'id_gergral');
        return view('administracion.personal.index', compact('cargo', 'estado', 'gergral'));
    }
    ...
    public function edit($id, Request $request)
    {
        ...
        $cargo = Cargo::pluck('descripcion', 'id_cargo'); 
        return response()->json(view('administracion.personal.edit', compact('personal', 'estado', 'gerencia','cargo'))->render());
    }
